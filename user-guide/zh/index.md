...
:root {
  ...
  --vp-home-hero-image-background-image: linear-gradient(135deg, rgba(102, 126, 234, 0.3) 0%, rgba(118, 75, 162, 0.25) 50%, rgba(240, 147, 251, 0.3) 100%);
...
.VPHero .image-container .image-src {
  animation: logo-float 6s ease-in-out infinite, logo-glow 3s ease-in-out infinite alternate;
}
