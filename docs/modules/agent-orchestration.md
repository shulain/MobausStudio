...
| 2025-01-30 | v1.1.0 | Claude | 完善圆桌讨论模式详细设计，添加接口定义和测试用例 |
| 2025-01-31 | v1.2.0 | Claude | 添加 Tauri 存储命令接口定义 |
| 2025-02-01 | v4.1.10 | Claude | 同步代码实现状态，完善测试用例文档，更新组件 API |
| 2025-02-01 | v4.1.13 | Claude | 新增 background 和 constraints 可选字段，支持设置讨论背景和约束 |
| 2025-02-05 | v3.5.0 | Claude | 统一消息渲染：共享 Markdown 组件、思考过程折叠、MCP 工具调用显示 |
| 2025-03-01 | v4.1.40 | Claude | 修复工具调用循环机制，工具执行后自动回传结果继续生成 |
