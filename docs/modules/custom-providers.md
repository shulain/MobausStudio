...
| 日期 | 版本 | 修改内容 | 修改人 |
|------|------|----------|--------|
| 2024-02-28 | v0.9.3 | 初始版本，支持多个自定义提供商和协议选择 | - |
| 2024-02-28 | v0.9.3.1 | 优化 API Key 编辑体验：显示配置状态，编辑时留空保持不变 | - |
| 2024-02-28 | v0.9.3.2 | 修复断开重连问题：断开连接不删除凭证，重连时自动填充已保存的 API Key | - |
| 2024-02-28 | v0.9.3.3 | 智能连接：已有 API Key 时直接连接，无需弹出输入框 | - |
| 2024-02-28 | v0.9.3.4 | 修复删除逻辑：同时删除凭证；统一布局：自定义提供商与其他提供商混合显示 | - |
